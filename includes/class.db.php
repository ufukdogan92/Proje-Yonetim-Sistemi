...
class db extends PDO {
	...
	public function delete($table, $where, $bind="",$debug=0) {
	...
	public function insert($table, $info, $debug=0) {
    ...
    public function select($table, $where="", $bind="", $fields="*",$debug=0) {
	...
	public function update($table, $info, $where, $bind="",$debug=0) {
		$fields = $this->filter($table, $info);
