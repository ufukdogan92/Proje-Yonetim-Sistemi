                        ...
                        <form class="form-horizontal">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" for="focusedInput">Proje Baþlýðý</label>
                                    <div class="controls">
                                        <input class="input-xlarge"  placeholder="Proje Baþlýðý Giriniz" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="selectError">Ders Seçiniz</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="date01">Bitiþ Tarihi Seçiniz</label>
                                    <div class="controls">
                                ...
                                <div class="control-group hidden-phone">
                                    <label class="control-label" for="textarea2">Proje Açýklamasý</label>
                                    <div class="controls">
